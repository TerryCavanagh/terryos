...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("data/apps/test.txt");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("data/fonts/volter/volter.fnt");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("data/fonts/volter/volter_0.png");
	...
	public static function main () {
		...
		config = {
			...
			packageName: "com.terrycavanaghgames.terryos",
			version: "1.0.0",
			windows: [
		...
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed (null, 320, 568, "000000");
		#end
		#else
		create ();
		#end

...
bool strict = __o_strict.Default(false);
	HX_STACK_FRAME("haxe.xml.Parser","parse",0x937905c3,"haxe.xml.Parser.parse","/usr/local/lib/haxe/std/haxe/xml/Parser.hx",65,0x9bd139bb)
...
int p = __o_p.Default(0);
	HX_STACK_FRAME("haxe.xml.Parser","doParse",0x2e9a6a38,"haxe.xml.Parser.doParse","/usr/local/lib/haxe/std/haxe/xml/Parser.hx",72,0x9bd139bb)
	HX_STACK_ARG(str,"str")
	HX_STACK_ARG(strict,"strict")
	HX_STACK_ARG(p,"p")
...
struct _Function_0_1{
	inline static ::haxe::ds::StringMap Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/local/lib/haxe/std/haxe/xml/Parser.hx",51,0x9bd139bb)
		{
			HX_STACK_LINE(52)

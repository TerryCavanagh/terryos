...
{
HX_STACK_FRAME("lime.app.Event_Float_Float_Float_Void","new",0xb243f81a,"lime.app.Event_Float_Float_Float_Void.new","lime/app/Event.hx",26,0xbda45bec)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(29)
	this->canceled = false;
...
{  hx::ObjectPtr< Event_Float_Float_Float_Void_obj > _result_ = new Event_Float_Float_Float_Void_obj();
...
int priority = __o_priority.Default(0);
	HX_STACK_FRAME("lime.app.Event_Float_Float_Float_Void","add",0xb23a19db,"lime.app.Event_Float_Float_Float_Void.add","lime/app/Event.hx",38,0xbda45bec)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("lime.app.Event_Float_Float_Float_Void","cancel",0x1e87d600,"lime.app.Event_Float_Float_Float_Void.cancel","lime/app/Event.hx",211,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_LINE(211)
		this->canceled = true;
	}
...
bool Event_Float_Float_Float_Void_obj::has( Dynamic listener){
	HX_STACK_FRAME("lime.app.Event_Float_Float_Float_Void","has",0xb23f6714,"lime.app.Event_Float_Float_Float_Void.has","lime/app/Event.hx",247,0xbda45bec)
	HX_STACK_THIS(this)
	HX_STACK_ARG(listener,"listener")
	HX_STACK_LINE(250)
	{
...
{
		HX_STACK_FRAME("lime.app.Event_Float_Float_Float_Void","remove",0x6adc84ca,"lime.app.Event_Float_Float_Float_Void.remove","lime/app/Event.hx",262,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_ARG(listener,"listener")
		HX_STACK_LINE(265)
...
{
		HX_STACK_FRAME("lime.app.Event_Float_Float_Float_Void","dispatch",0xafe764c0,"lime.app.Event_Float_Float_Float_Void.dispatch","lime/app/Event.hx",135,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_ARG(a,"a")
		HX_STACK_ARG(a1,"a1")
		HX_STACK_ARG(a2,"a2")
		...
		while((true)){
			...
			HX_STACK_LINE(14)
			Float tmp5 = a2;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(145)
...
Dynamic Event_Float_Float_Float_Void_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic Event_Float_Float_Float_Void_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*Array< bool >*/ ,(int)offsetof(Event_Float_Float_Float_Void_obj,__repeat),HX_HCSTRING("__repeat","\x7b","\x02","\xac","\xae")},
	{hx::fsObject /*Array< int >*/ ,(int)offsetof(Event_Float_Float_Float_Void_obj,__priorities),HX_HCSTRING("__priorities","\xe2","\xcb","\xe6","\x1c")},
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(Event_Float_Float_Float_Void_obj,__listeners),HX_HCSTRING("__listeners","\x5f","\xae","\xba","\x21")},
	{ hx::fsUnknown, 0, null()}
};

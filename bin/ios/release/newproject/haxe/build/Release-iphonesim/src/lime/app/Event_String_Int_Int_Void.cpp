...
Void Event_String_Int_Int_Void_obj::__construct()
{
HX_STACK_FRAME("lime.app.Event_String_Int_Int_Void","new",0x43ba1769,"lime.app.Event_String_Int_Int_Void.new","lime/app/Event.hx",26,0xbda45bec)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(29)
	this->canceled = false;
...
//Event_String_Int_Int_Void_obj::~Event_String_Int_Int_Void_obj() { }

Dynamic Event_String_Int_Int_Void_obj::__CreateEmpty() { return  new Event_String_Int_Int_Void_obj; }
hx::ObjectPtr< Event_String_Int_Int_Void_obj > Event_String_Int_Int_Void_obj::__new()
{  hx::ObjectPtr< Event_String_Int_Int_Void_obj > _result_ = new Event_String_Int_Int_Void_obj();
	_result_->__construct();
	return _result_;}

Dynamic Event_String_Int_Int_Void_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< Event_String_Int_Int_Void_obj > _result_ = new Event_String_Int_Int_Void_obj();
	_result_->__construct();
	return _result_;}

Void Event_String_Int_Int_Void_obj::add( Dynamic listener,hx::Null< bool >  __o_once,hx::Null< int >  __o_priority){
bool once = __o_once.Default(false);
int priority = __o_priority.Default(0);
	HX_STACK_FRAME("lime.app.Event_String_Int_Int_Void","add",0x43b0392a,"lime.app.Event_String_Int_Int_Void.add","lime/app/Event.hx",38,0xbda45bec)
	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC3(Event_String_Int_Int_Void_obj,add,(void))

Void Event_String_Int_Int_Void_obj::cancel( ){
{
		HX_STACK_FRAME("lime.app.Event_String_Int_Int_Void","cancel",0x0ca6f211,"lime.app.Event_String_Int_Int_Void.cancel","lime/app/Event.hx",211,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_LINE(211)
		this->canceled = true;
	}
...
HX_DEFINE_DYNAMIC_FUNC0(Event_String_Int_Int_Void_obj,cancel,(void))

bool Event_String_Int_Int_Void_obj::has( Dynamic listener){
	HX_STACK_FRAME("lime.app.Event_String_Int_Int_Void","has",0x43b58663,"lime.app.Event_String_Int_Int_Void.has","lime/app/Event.hx",247,0xbda45bec)
	HX_STACK_THIS(this)
	HX_STACK_ARG(listener,"listener")
	HX_STACK_LINE(250)
	{
...
HX_DEFINE_DYNAMIC_FUNC1(Event_String_Int_Int_Void_obj,has,return )

Void Event_String_Int_Int_Void_obj::remove( Dynamic listener){
{
		HX_STACK_FRAME("lime.app.Event_String_Int_Int_Void","remove",0x58fba0db,"lime.app.Event_String_Int_Int_Void.remove","lime/app/Event.hx",262,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_ARG(listener,"listener")
		HX_STACK_LINE(265)
...
HX_DEFINE_DYNAMIC_FUNC1(Event_String_Int_Int_Void_obj,remove,(void))

Void Event_String_Int_Int_Void_obj::dispatch( ::String a,int a1,int a2){
{
		HX_STACK_FRAME("lime.app.Event_String_Int_Int_Void","dispatch",0xb9126711,"lime.app.Event_String_Int_Int_Void.dispatch","lime/app/Event.hx",135,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_ARG(a,"a")
		HX_STACK_ARG(a1,"a1")
		HX_STACK_ARG(a2,"a2")
...
HX_DEFINE_DYNAMIC_FUNC3(Event_String_Int_Int_Void_obj,dispatch,(void))
...
void Event_String_Int_Int_Void_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(Event_String_Int_Int_Void);
...
void Event_String_Int_Int_Void_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic Event_String_Int_Int_Void_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic Event_String_Int_Int_Void_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
...
void Event_String_Int_Int_Void_obj::__GetFields(Array< ::String> &outFields)
{
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsBool,(int)offsetof(Event_String_Int_Int_Void_obj,canceled),HX_HCSTRING("canceled","\x59","\x18","\x26","\x1f")},
	{hx::fsObject /*Array< bool >*/ ,(int)offsetof(Event_String_Int_Int_Void_obj,__repeat),HX_HCSTRING("__repeat","\x7b","\x02","\xac","\xae")},
	{hx::fsObject /*Array< int >*/ ,(int)offsetof(Event_String_Int_Int_Void_obj,__priorities),HX_HCSTRING("__priorities","\xe2","\xcb","\xe6","\x1c")},
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(Event_String_Int_Int_Void_obj,__listeners),HX_HCSTRING("__listeners","\x5f","\xae","\xba","\x21")},
	{ hx::fsUnknown, 0, null()}
};
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Event_String_Int_Int_Void_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(Event_String_Int_Int_Void_obj::__mClass,"__mClass");
};

#endif

hx::Class Event_String_Int_Int_Void_obj::__mClass;

void Event_String_Int_Int_Void_obj::__register()
{
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("lime.app.Event_String_Int_Int_Void","\xf7","\x2e","\x56","\x1b");
	...
	__mClass->mCanCast = hx::TCanCast< Event_String_Int_Int_Void_obj >;
#ifdef HXCPP_VISIT_ALLOCS

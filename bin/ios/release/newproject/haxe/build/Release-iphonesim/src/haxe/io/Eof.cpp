...
{
HX_STACK_FRAME("haxe.io.Eof","new",0x2166e64e,"haxe.io.Eof.new","/usr/local/lib/haxe/std/haxe/io/Eof.hx",28,0x6ea6ebff)
HX_STACK_THIS(this)
{
}
;
...
::String Eof_obj::toString( ){
	HX_STACK_FRAME("haxe.io.Eof","toString",0xf9ff7bfe,"haxe.io.Eof.toString","/usr/local/lib/haxe/std/haxe/io/Eof.hx",31,0x6ea6ebff)
	HX_STACK_THIS(this)
	HX_STACK_LINE(31)

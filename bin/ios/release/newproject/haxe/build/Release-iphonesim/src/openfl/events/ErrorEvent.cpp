...
::openfl::events::Event ErrorEvent_obj::clone( ){
	...
	HX_STACK_LINE(26)
	::openfl::events::ErrorEvent tmp9 = event;		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(26)
	return tmp9;
}
...
::String ErrorEvent_obj::toString( ){
	HX_STACK_FRAME("openfl.events.ErrorEvent","toString",0x299f6791,"openfl.events.ErrorEvent.toString","openfl/events/ErrorEvent.hx",31,0x9d2fc215)
	HX_STACK_THIS(this)
	HX_STACK_LINE(33)

...
::openfl::events::Event IOErrorEvent_obj::clone( ){
	...
	HX_STACK_LINE(23)
	::openfl::events::IOErrorEvent tmp9 = event;		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(23)
	return tmp9;
}
...
::String IOErrorEvent_obj::toString( ){
	HX_STACK_FRAME("openfl.events.IOErrorEvent","toString",0xfbbd53ab,"openfl.events.IOErrorEvent.toString","openfl/events/IOErrorEvent.hx",28,0x9ba976af)
	HX_STACK_THIS(this)
	HX_STACK_LINE(30)

...
{
HX_STACK_FRAME("haxe.io.BytesInput","new",0x7fa18571,"haxe.io.BytesInput.new","/usr/local/lib/haxe/std/haxe/io/BytesInput.hx",38,0x977e71a2)
HX_STACK_THIS(this)
HX_STACK_ARG(b,"b")
...
int BytesInput_obj::readByte( ){
	HX_STACK_FRAME("haxe.io.BytesInput","readByte",0xb70e46cd,"haxe.io.BytesInput.readByte","/usr/local/lib/haxe/std/haxe/io/BytesInput.hx",90,0x977e71a2)
	HX_STACK_THIS(this)
	HX_STACK_LINE(94)
...
int BytesInput_obj::readBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_FRAME("haxe.io.BytesInput","readBytes",0x756fad06,"haxe.io.BytesInput.readBytes","/usr/local/lib/haxe/std/haxe/io/BytesInput.hx",111,0x977e71a2)
	HX_STACK_THIS(this)

...
{
HX_STACK_FRAME("lime.app.Event_Dynamic_Void","new",0x7b151c91,"lime.app.Event_Dynamic_Void.new","lime/app/Event.hx",26,0xbda45bec)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(29)
	this->canceled = false;
...
int priority = __o_priority.Default(0);
	HX_STACK_FRAME("lime.app.Event_Dynamic_Void","add",0x7b0b3e52,"lime.app.Event_Dynamic_Void.add","lime/app/Event.hx",38,0xbda45bec)
	HX_STACK_THIS(this)
...
Void Event_Dynamic_Void_obj::cancel( ){
{
		HX_STACK_FRAME("lime.app.Event_Dynamic_Void","cancel",0x08ad95e9,"lime.app.Event_Dynamic_Void.cancel","lime/app/Event.hx",211,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_LINE(211)
		this->canceled = true;
	}
...
HX_DEFINE_DYNAMIC_FUNC0(Event_Dynamic_Void_obj,cancel,(void))

bool Event_Dynamic_Void_obj::has( Dynamic listener){
	HX_STACK_FRAME("lime.app.Event_Dynamic_Void","has",0x7b108b8b,"lime.app.Event_Dynamic_Void.has","lime/app/Event.hx",247,0xbda45bec)
	HX_STACK_THIS(this)
	HX_STACK_ARG(listener,"listener")
	HX_STACK_LINE(250)
	{
...
{
		HX_STACK_FRAME("lime.app.Event_Dynamic_Void","remove",0x550244b3,"lime.app.Event_Dynamic_Void.remove","lime/app/Event.hx",262,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_ARG(listener,"listener")
		HX_STACK_LINE(265)
...
{
		HX_STACK_FRAME("lime.app.Event_Dynamic_Void","dispatch",0xbeebb0e9,"lime.app.Event_Dynamic_Void.dispatch","lime/app/Event.hx",135,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_ARG(a,"a")
		HX_STACK_LINE(137)
		this->canceled = false;
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsBool,(int)offsetof(Event_Dynamic_Void_obj,canceled),HX_HCSTRING("canceled","\x59","\x18","\x26","\x1f")},
	{hx::fsObject /*Array< bool >*/ ,(int)offsetof(Event_Dynamic_Void_obj,__repeat),HX_HCSTRING("__repeat","\x7b","\x02","\xac","\xae")},
	{hx::fsObject /*Array< int >*/ ,(int)offsetof(Event_Dynamic_Void_obj,__priorities),HX_HCSTRING("__priorities","\xe2","\xcb","\xe6","\x1c")},
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(Event_Dynamic_Void_obj,__listeners),HX_HCSTRING("__listeners","\x5f","\xae","\xba","\x21")},
	{ hx::fsUnknown, 0, null()}
};

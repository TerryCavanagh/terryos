...
{
HX_STACK_FRAME("lime.app.Event_lime_graphics_RenderContext_Void","new",0x21dccae1,"lime.app.Event_lime_graphics_RenderContext_Void.new","lime/app/Event.hx",26,0xbda45bec)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(29)
	this->canceled = false;
...
{  hx::ObjectPtr< Event_lime_graphics_RenderContext_Void_obj > _result_ = new Event_lime_graphics_RenderContext_Void_obj();
...
int priority = __o_priority.Default(0);
	HX_STACK_FRAME("lime.app.Event_lime_graphics_RenderContext_Void","add",0x21d2eca2,"lime.app.Event_lime_graphics_RenderContext_Void.add","lime/app/Event.hx",38,0xbda45bec)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("lime.app.Event_lime_graphics_RenderContext_Void","cancel",0xd047b999,"lime.app.Event_lime_graphics_RenderContext_Void.cancel","lime/app/Event.hx",211,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_LINE(211)
		this->canceled = true;
	}
...
bool Event_lime_graphics_RenderContext_Void_obj::has( Dynamic listener){
	HX_STACK_FRAME("lime.app.Event_lime_graphics_RenderContext_Void","has",0x21d839db,"lime.app.Event_lime_graphics_RenderContext_Void.has","lime/app/Event.hx",247,0xbda45bec)
	HX_STACK_THIS(this)
	HX_STACK_ARG(listener,"listener")
	HX_STACK_LINE(250)
	{
...
{
		HX_STACK_FRAME("lime.app.Event_lime_graphics_RenderContext_Void","remove",0x1c9c6863,"lime.app.Event_lime_graphics_RenderContext_Void.remove","lime/app/Event.hx",262,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_ARG(listener,"listener")
		HX_STACK_LINE(265)
...
{
		HX_STACK_FRAME("lime.app.Event_lime_graphics_RenderContext_Void","dispatch",0x3c1a2099,"lime.app.Event_lime_graphics_RenderContext_Void.dispatch","lime/app/Event.hx",135,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_ARG(a,"a")
		HX_STACK_LINE(137)
		this->canceled = false;
		...
		while((true)){
			...
			HX_STACK_LINE(14)
			::lime::graphics::RenderContext tmp3 = a;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(145)
			tmp2(tmp3).Cast< Void >();
			HX_STACK_LINE(147)
...
Dynamic Event_lime_graphics_RenderContext_Void_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic Event_lime_graphics_RenderContext_Void_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*Array< bool >*/ ,(int)offsetof(Event_lime_graphics_RenderContext_Void_obj,__repeat),HX_HCSTRING("__repeat","\x7b","\x02","\xac","\xae")},
	{hx::fsObject /*Array< int >*/ ,(int)offsetof(Event_lime_graphics_RenderContext_Void_obj,__priorities),HX_HCSTRING("__priorities","\xe2","\xcb","\xe6","\x1c")},
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(Event_lime_graphics_RenderContext_Void_obj,__listeners),HX_HCSTRING("__listeners","\x5f","\xae","\xba","\x21")},
	{ hx::fsUnknown, 0, null()}
};

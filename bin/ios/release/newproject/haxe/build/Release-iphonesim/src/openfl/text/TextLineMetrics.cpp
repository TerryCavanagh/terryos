...
{
HX_STACK_FRAME("openfl.text.TextLineMetrics","new",0x08194531,"openfl.text.TextLineMetrics.new","openfl/text/TextLineMetrics.hx",15,0x3c3b1fbf)
HX_STACK_THIS(this)
HX_STACK_ARG(x,"x")
...
{  hx::ObjectPtr< TextLineMetrics_obj > _result_ = new TextLineMetrics_obj();
	_result_->__construct(x,width,height,ascent,descent,leading);
	return _result_;}

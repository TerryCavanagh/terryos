...
Dynamic ALContext_Impl__obj::_new( Dynamic handle){
	HX_STACK_FRAME("lime.audio.openal._ALContext.ALContext_Impl_","_new",0x8157c58c,"lime.audio.openal._ALContext.ALContext_Impl_._new","lime/audio/openal/ALContext.hx",15,0x378e7da1)

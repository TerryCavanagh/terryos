...
::openfl::events::Event ProgressEvent_obj::clone( ){
	...
	HX_STACK_LINE(30)
	::openfl::events::ProgressEvent tmp9 = event;		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(30)
	return tmp9;
}
...
::String ProgressEvent_obj::toString( ){
	HX_STACK_FRAME("openfl.events.ProgressEvent","toString",0x8ba16d84,"openfl.events.ProgressEvent.toString","openfl/events/ProgressEvent.hx",35,0xea3bf808)
	HX_STACK_THIS(this)
	HX_STACK_LINE(37)

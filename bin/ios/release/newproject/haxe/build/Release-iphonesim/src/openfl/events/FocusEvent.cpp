...
::openfl::events::Event FocusEvent_obj::clone( ){
	...
	HX_STACK_LINE(33)
	::openfl::display::InteractiveObject tmp3 = this->relatedObject;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(33)
	...
	event->target = tmp7;
	HX_STACK_LINE(35)
	Dynamic tmp8 = this->currentTarget;		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(35)
	event->currentTarget = tmp8;
	HX_STACK_LINE(36)
	int tmp9 = this->eventPhase;		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(36)
	event->eventPhase = tmp9;
	HX_STACK_LINE(37)
...
::String FocusEvent_obj::toString( ){
	HX_STACK_FRAME("openfl.events.FocusEvent","toString",0x8b53f7a1,"openfl.events.FocusEvent.toString","openfl/events/FocusEvent.hx",42,0xe559e625)
	HX_STACK_THIS(this)
	HX_STACK_LINE(44)

...
class HXCPP_CLASS_ATTRIBUTES  Texture_obj : public ::openfl::display3D::textures::TextureBase_obj{
	...
	public:
		...
		static int __getATFVersion( ::openfl::utils::ByteArrayData data);
		static Dynamic __getATFVersion_dyn();

		static int __readUInt24( ::openfl::utils::ByteArrayData data);
		static Dynamic __readUInt24_dyn();

		static int __readUInt32( ::openfl::utils::ByteArrayData data);
		static Dynamic __readUInt32_dyn();

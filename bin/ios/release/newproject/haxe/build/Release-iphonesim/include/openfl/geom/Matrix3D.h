...
class HXCPP_CLASS_ATTRIBUTES  Matrix3D_obj : public hx::Object{
	...
	public:
		...
		virtual Void copyRawDataFrom( ::openfl::_Vector::FloatVector vector,hx::Null< int >  index,hx::Null< bool >  transpose);
		Dynamic copyRawDataFrom_dyn();

		virtual Void copyRawDataTo( ::openfl::_Vector::FloatVector vector,hx::Null< int >  index,hx::Null< bool >  transpose);
		...
		virtual ::openfl::_Vector::ObjectVector decompose( Dynamic orientationStyle);
		...
		virtual bool recompose( ::openfl::_Vector::ObjectVector components,Dynamic orientationStyle);
		Dynamic recompose_dyn();

		virtual ::openfl::geom::Vector3D transformVector( ::openfl::geom::Vector3D v);
		Dynamic transformVector_dyn();

		virtual Void transformVectors( ::openfl::_Vector::FloatVector vin,::openfl::_Vector::FloatVector vout);

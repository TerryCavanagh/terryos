...
class HXCPP_CLASS_ATTRIBUTES  MouseEvent_obj : public ::openfl::events::Event_obj{
	...
	public:
		...
		static bool __altKey;
		static bool __buttonDown;
		static bool __commandKey;
		static bool __ctrlKey;
		static bool __shiftKey;
		static ::openfl::events::MouseEvent __create( ::String type,int button,Float stageX,Float stageY,::openfl::geom::Point local,::openfl::display::InteractiveObject target,hx::Null< int >  delta);

...
virtual Dynamic readByte_dyn()=0;
		virtual Void readBytes( ::openfl::utils::ByteArrayData bytes,hx::Null< int >  offset,hx::Null< int >  length)=0;
...
virtual Dynamic readInt_dyn()=0;
		virtual ::String readMultiByte( int length,::String charSet)=0;
virtual Dynamic readMultiByte_dyn()=0;
...
class IDataInput_delegate_ : public IDataInput_obj
{
	...
	public:
		...
		Void readBytes( ::openfl::utils::ByteArrayData bytes,hx::Null< int >  offset,hx::Null< int >  length) { return mDelegate->readBytes(bytes,offset,length);}
		...
		::String readMultiByte( int length,::String charSet) { return mDelegate->readMultiByte(length,charSet);}
		Dynamic readMultiByte_dyn() { return mDelegate->readMultiByte_dyn();}

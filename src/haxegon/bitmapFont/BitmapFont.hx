...
class BitmapFont
{
	 ...
	 */
	public function prepareGlyphs(scale:Float, color:UInt, useColor:Bool = true, smoothing:Bool = false):BitmapGlyphCollection
	{
...
class BitmapGlyphCollection
{
	...
	public function new(font:BitmapFont, scale:Float, color:UInt, useColor:Bool = true, smoothing:Bool = false)
	{
	...
	private function prepareGlyphs(smoothing:Bool = false):Void
	{
